...
class ApiClient {
  ...
  Future<List<EmpServer>> servers() async {
    ...
    return ((jsonDecode(res.body) as Map<String, dynamic>)['servers'] as List)
        .map((item) => EmpServer.fromJson(item as Map<String, dynamic>))
        .toList();
  }
  ...
  Future<Map<String, dynamic>?> latest(String id) async {
    ...
    return ((jsonDecode(res.body) as Map<String, dynamic>)['latest']
        as Map<String, dynamic>?)?['snapshot'] as Map<String, dynamic>?;
  }
  ...
  Future<List<dynamic>> alerts(String? id) async {
    ...
    return (jsonDecode(res.body) as Map<String, dynamic>)['alerts']
        as List<dynamic>;
  }
  ...
  Future<List<dynamic>> logs(String id) async {
    ...
    return (jsonDecode(res.body) as Map<String, dynamic>)['logs']
        as List<dynamic>;
  }
  ...
  Future<List<dynamic>> securityEvents(String id) async {
    ...
    return (jsonDecode(res.body) as Map<String, dynamic>)['events']
        as List<dynamic>;
  }
  ...
  Future<Map<String, dynamic>> sendCommand(
    ...
    final res = await http.post(
      Uri.parse('$baseUrl/servers/$id/commands'),
      headers: _headers(),
      body: jsonEncode({
        'command': command,
        'confirmed': confirmed,
