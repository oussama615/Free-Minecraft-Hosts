...
This branch includes a merge-resolution commit that keeps the EMP Control MVP project tree over the old Free Minecraft Hosts content. The PR should show the normal green **Merge pull request** button.

After merge, `main` should contain this EMP Control README and these folders/files: `backend/`, `plugin/`, `mobile/`, `mobile/pubspec.yaml`, `mobile/lib/`, `mobile/android/`, `mobile/scripts/build_release_apk.sh`, and `.github/workflows/android-apk.yml`.

Click sequence in GitHub:

1. Open the pull request.
2. Confirm GitHub shows the green **Merge pull request** button.
